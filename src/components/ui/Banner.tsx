...
const Banner: React.FC<BannerProps> = ({
      ...
      return (
        <a
          ...
          className={cn(
            ...
            "shadow-xs",
            ctaItem.variant === "primary" &&
              "bg-primary-500 text-white hover:bg-primary-600 focus:ring-primary-500",
            ctaItem.variant === "secondary" &&
            ...
            ctaItem.variant === "ghost" &&
              "bg-transparent text-gray-700 hover:bg-gray-100 focus:ring-gray-500",
            ctaItem.size === "sm" && "text-sm px-3 py-1.5 h-8",
            ctaItem.size === "md" && "text-base px-4 py-2 h-10",
            ctaItem.size === "lg" && "text-lg px-6 py-3 h-12",
            (!ctaItem.size || ctaItem.size === "md") && "text-base px-4 py-2 h-10"
          )}
        >
          {ctaItem.label}
        </a>
  ...
  if (cta) {
    ...
    return (
      <div className={cn("relative rounded-lg p-4", currentStyles.container, className)}>
        <div className="items-center md:flex">
          ...
          <div className="flex justify-center md:w-1/3 md:justify-end">
            <div className="flex items-center space-x-2">
              {ctaArray.map((ctaItem, index) => renderCTAButton(ctaItem, index))}
              {onDismiss && (
                <button
                  onClick={onDismiss}
    ...
    >
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className={cn(currentStyles.description, "text-sm")}>{description}</p>
        </div>
      </div>
    </div>
  );
